...
# how to write accurate tests here?
    ...
    assert frequent_words("The the the the quick quick quick brown brown fox") == ['the', 'quick', 'brown']
    assert frequent_words("The the quick quick the quick brown brown the fox") == ['the', 'quick', 'brown']
