# For each class give its name and what other classes it inherits from.
    # MysqlPython, inherits from object.
# Under that, list every function it has and the parameters they take.
    # __new__(cls, *args, **kwargs)
    # __init__(self, host='localhost'), user = 'root')
    # __open(self)
    # __close(self)
...
# For each attribute, give the class this attribute is.
    # what's this mean? None/null?

# from: https://github.com/nestordeharo/mysql-python-class/blob/master/mysql_python.py
